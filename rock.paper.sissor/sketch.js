...
let userName = prompt("Welcome to Rock Paper Scissors! What is your name?");
let playCount = prompt("How many times should the winner win? Enter a number.");
let computerChoice;
let user_count = 0;
let computer_count = 0;

// function preload() {
//   Scissors = loadImage('img/Scissors.png'); // image of scissors preloaded
//   Rock = loadImage('img/Rock.png'); // image of rock preloaded
//   Paper = loadImage('img/Paper.png'); // image of paper preloaded
//   Scissors2 = loadImage('img/Scissors2.png'); // image of scissors (user's perspective) preloaded
//   Rock2 = loadImage('img/Rock2.png'); // image of rock (user's perspective) preloaded
//   Paper2 = loadImage('img/Paper2.png'); // image of paper (user's perspective) preloaded
//   Scissors3 = loadImage('img/Scissors3.png'); // image of scissors (for button below) preloaded
//   Rock3 = loadImage('img/Rock3.png'); // image of rock (for button below) preloaded
//   Paper3 = loadImage('img/Paper3.png'); // image of paper (for button below) preloaded
//   win = loadImage('img/win.png'); // image of "win" sign preloaded
//   lost = loadImage('img/lost.png'); // image of "lost" sign preloaded
// }
